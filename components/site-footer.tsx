...
const footerLinks = [
  { heading: 'Practice tools', links: [{ label: 'Data entry practice', href: '/train' }, { label: 'Memory practice', href: '/train' }, { label: 'Pressure training', href: '/train' }, { label: 'Free assessment', href: '/assessment' }] },
  { heading: 'Product', links: [{ label: 'How it works', href: '/#how-it-works' }, { label: 'Training modules', href: '/#modules' }, { label: 'Readiness report', href: '/#report' }, { label: 'Pricing', href: '/#pricing' }] },
