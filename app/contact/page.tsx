...
export const metadata: Metadata = { title: 'Contact | DispatchReady', description: 'Contact DispatchReady about product, privacy, or accessibility questions.', alternates: { canonical: '/contact' }, robots: { index: false, follow: true } }
